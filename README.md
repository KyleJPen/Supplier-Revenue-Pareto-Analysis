...
Explored trends in supplier performance and order patterns.

Used SQL scripts to prepare and aggregate data for analysis.

Created DAX measures for key metrics in the Power BI dashboard.

Built a dashboard to visualize supplier performance, revenue distribution, and order trends.
...
Detailed explanations and recommendations are provided in the Executive Summary
.
