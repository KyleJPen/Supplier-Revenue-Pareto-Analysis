...
│   └── sql_scripts/           # SQL queries used to prepare and analyze data
├── data/
│   ├── original_data_tables/   # original dataset tables used in analysis
│   └── tables_screenshots/     # screenshots from initial exploration
├── dashboard_screenshot.png    # screenshot of final dashboard
└── executive_summary.docx      # summary of findings and recommendations
```

*The dashboard folder contains all DAX measures and SQL scripts used to generate insights. The data folder captures both the original data tables and screenshots from initial exploration, documenting the workflow prior to building the dashboard.*
